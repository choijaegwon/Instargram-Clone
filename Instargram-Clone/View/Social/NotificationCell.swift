...
class NotificationCell: UITableViewCell {
    ...
    func configureNotificationType() {
        ...
        notificationLabel.anchor(top: nil, left: profileImageView.rightAnchor, bottom: nil, right: nil, paddingTop: 0, paddingLeft: 8, paddingBottm: 0, paddingRight: 100, width: 0, height: 0)
